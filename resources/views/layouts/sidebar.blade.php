    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          @else
          <img src="{{asset('img/user/nofoto.png')}}" class="img-circle elevation-2" alt="User Image">
          @endif
        </div>
        
        <div class="info">
           <a class="d-block" href="{{url('/profile')}}"  role="button" >{{ substr(Auth::user()->name, 0 , 17) }}</a>
        </div>
        </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('logout') }}" class="nav-link href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"">
