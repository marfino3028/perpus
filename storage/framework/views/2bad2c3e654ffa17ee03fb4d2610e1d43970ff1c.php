...
<?php
$ar_judul = ['No','Nama','Materi','Action']; 
$no = 1; 
?>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo e($guru->pelajaran); ?></td>
                  
                  <td>
                    <form method="POST" action="<?php echo e(route('guru.destroy',$guru->id)); ?>">
                    <a href="<?php echo e(route('guru.show',$guru->id)); ?>" class="btn btn-success"><i class="far fa-eye"></i></a>
                    <a href="<?php echo e(route('guru.edit',$guru->id)); ?>" class="btn btn-warning"><i class="fas fa-pen-alt"></i></a> 
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lavmakan\resources\views/guru/index.blade.php ENDPATH**/ ?>