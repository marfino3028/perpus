<!-- Navbar -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(substr(Auth::user()->name, 0 , 17)); ?></span>
  ...
  <!-- /.navbar --><?php /**PATH C:\xampp2\htdocs\perpus\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>