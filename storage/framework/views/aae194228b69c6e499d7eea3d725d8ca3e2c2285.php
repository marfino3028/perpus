      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>">Ruang Baca</a></li>
        ...
        <div class="container">
          ...
          <div class="row"> 
            <div class="col-lg-3 col-xs-6">
              <div class="thumb">
                <img class="f-img img-fluid mx-auto" src="<?php echo e(asset('img/devrio-1.jpg')); ?>" alt=""> 
              </div><br>
              <div class="bottom d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  <img class="img-fluid" src="<?php echo e(asset('img/devrio.png')); ?>" alt="">
            ...
            <div class="col-lg-3 col-xs-6">
              <div class="thumb">
                <img class="f-img img-fluid mx-auto" src="<?php echo e(asset('note/img/marco.jpg')); ?>" alt=""> 
              </div><br>
              <div class="bottom d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  <img class="img-fluid" src="<?php echo e(asset('img/marco.png')); ?>" alt="">
            ...
            <div class="col-lg-3 col-xs-6">
              <div class="thumb">
                <img class="f-img img-fluid mx-auto" src="<?php echo e(asset('note/img/imam.jpg')); ?>" alt=""> 
              </div><br>
              <div class="bottom d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  <img class="img-fluid" src="<?php echo e(asset('img/imam.png')); ?>" alt="">
          ...
          <div class="col-lg-3 col-xs-6">
              <div class="thumb">
                <img class="f-img img-fluid mx-auto" src="<?php echo e(asset('note/img/cahyo.png')); ?>" alt=""> 
              </div><br>
              <div class="bottom d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  <img class="img-fluid" src="<?php echo e(asset('img/cahyo.png')); ?>" alt="">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\resources\views/layouts/about.blade.php ENDPATH**/ ?>