    ...
    <div class="form-group row">
      <div class="col-4">
        <?php if(!empty(Auth::user()->foto)): ?>
                <img class="img-fluid px-7 px-sm--2 mt-3 mb-4" style="width: 32rem; " src="<?php echo e(asset('img/user/'.Auth::user()->foto)); ?>"></td>
                <?php else: ?>
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 32rem;" src="<?php echo e(asset('img/user/nofoto.png')); ?>" alt="">
                <?php endif; ?> 
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\resources\views/profile/form_edit.blade.php ENDPATH**/ ?>