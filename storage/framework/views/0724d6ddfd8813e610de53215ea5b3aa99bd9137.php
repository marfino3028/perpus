...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis')); ?>" />
        <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<div class="form-group row">
    ...
    <div class="col-8">
      <select name="buku" class="custom-select <?php $__errorArgs = ['buku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
        ...
        <option value="<?php echo e($buk['id']); ?>" <?php if(old('buku') == $buk['id']): ?> selected <?php endif; ?>> <?php echo e($buk['nama']); ?> </option>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\resources\views/anggota/form.blade.php ENDPATH**/ ?>