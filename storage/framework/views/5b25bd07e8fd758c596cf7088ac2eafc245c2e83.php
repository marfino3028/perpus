...
unset($__errorArgs, $__bag); ?>
 ...
 <!--  <div class="form-group row">
    ...
    <div class="col-8">
    <input id="jenis" name="jenis" type="text" 
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('jenis')); ?>" />
      <?php $__errorArgs = ['jenis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\resources\views/buku/form.blade.php ENDPATH**/ ?>